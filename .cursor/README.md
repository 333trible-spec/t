...
| `.cursor/agents/` | да | Гарри, Витёк, Гена, База знаний, Дизайнер, Шейх |
...
| Агент | Вызов | Зона |
|-------|-------|------|
| **Гарри** | `/garri` | Cursor, VPN, ПК, файлы |
...
| **Шейх** | `/sheikh` | Нефть Brent/Urals; MOEX + Yahoo (акции, облигации, фьючерсы) |
