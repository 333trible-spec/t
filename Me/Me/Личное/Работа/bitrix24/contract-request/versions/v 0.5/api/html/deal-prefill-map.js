...
window.BP608_DEAL_PREFILL_MAP = [
  ...
  { param: 'sber', deal: 'UF_CRM_1722941445', label: 'Приложение СБЕР', yesNo: ['Есть', 'Нет'] },
...
window.BP608_DEAL_PREFILL_UNMAPPED = [
  { param: 'Parameter3', label: 'ЗАПОЛНИ ФИО КЛИЕНТА', reason: 'убрано из формы; флаг БП, не поле сделки' },
];
